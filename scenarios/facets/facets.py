# $Id: facets.py 6047 2012-09-27 21:12:37Z sprater $
#
# Query SOLR facets for Forward
#
...
facetBaseURL = urljoin(baseURL, 'catalog?q=')

# Read in the facets, put them in a hash
file = open("data/queries.txt", 'r')
lines = file.readlines()

file.close()

test1 = Test(1, "Forward SOLR Facets Test")
...
class TestRunner:
	...
	# Do a single request to launch the Forward Ruby app
        ...
        result = request1.GET(facetBaseURL + query)
